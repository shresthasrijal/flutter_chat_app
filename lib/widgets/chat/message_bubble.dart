...
import 'package:projj12_chatapp/screens/secondary_screens/chat_image.dart';
import 'package:projj12_chatapp/screens/secondary_screens/chat_video.dart';
import 'package:projj12_chatapp/utility/video_thumbnail.dart';
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (ctx) => ChatImageScreen(imageUrl!),
                          ),
                        );
                      },
                      child: Container(
                  ...
                  if (videoUrl != '')
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (ctx) => ChatVideoScreen(videoUrl!),
                          ),
                        );
                      },
                      child: Container(
                        ...
                        child: Center(
                          // Center widget to align child
                          child: VideoThumbnail(videoUrl: videoUrl!),
                        ),
                      ),
                    ),
                  // if ends here
